            ...
            <div class="content-page-header">
                ...
                <div class="list-btn">
                    <ul class="filter-list">
                        <li>
                            <a class="btn btn-primary" href="sss-ekle"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Yeni Soru Ekle</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    while ($row = $veriCek->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            ...
                                            <td align="right">
                                                <a href="sss-duzenle?id=<?= $row['id'] ?>" class="btn btn-success text-white btn-sm"><i class="fe fe-edit"></i>
                                                </a>
                                                <a href="#" data-id="<?= $row['id'] ?>" class="btn btn-danger text-white btn-sm SilBtn"><i class="fe fe-trash-2"></i> </a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
