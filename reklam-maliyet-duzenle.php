...
if (isset($_GET['id']) and $_GET['id'] != '' and $_GET['id'] != 0) {
    ...
    $data = $conn->query("SELECT * FROM reklam_maliyetler WHERE rekalm_maliyet_id = $id")->fetch(PDO::FETCH_ASSOC);
    if (!$data) {
        header('Location: reklam-maliyet-listesi?durum=gecersizIslem');
        die();
    }
} else {
    header('Location: reklam-maliyet-listesi?durum=gecersizIslem');
...
$pageName = 'Reklam Maliyet Düzenle';
$meta = array(
                        ...
                        <form action="islemler.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            <option
                                                                                <?= ($data['rekalm_maliyet_urun'] == $row['urun_id']) ? 'selected' : ''; ?>
                                                                                value="<?= $row['urun_id']; ?>"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        <label>Domain</label>
                                                                        <input type="hidden" name="maliyet_id"
                                                                            value="<?= $data['rekalm_maliyet_id']; ?>">
                                                                        <input type="text" name="domain" id="domain"
                                                                            class="form-control border-danger"
                                                                            value="<?= $data['rekalm_maliyet_domain']; ?>"
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="meta"
                                                                            class="form-control border-danger"
                                                                            placeholder="Meta"
                                                                            value="<?= $data['rekalm_maliyet_meta']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="tiktok"
                                                                            class="form-control border-danger"
                                                                            placeholder="Tiktok"
                                                                            value="<?= $data['rekalm_maliyet_tiktok']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="google"
                                                                            class="form-control border-danger"
                                                                            placeholder="Google"
                                                                            value="<?= $data['rekalm_maliyet_google']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="twitter"
                                                                            class="form-control border-danger"
                                                                            placeholder="Twitter"
                                                                            value="<?= $data['rekalm_maliyet_twitter']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="manuel_1"
                                                                            class="form-control border-danger"
                                                                            placeholder="Manuel Ekleme"
                                                                            value="<?= $data['rekalm_maliyet_man']; ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="manuel_2"
                                                                            class="form-control border-danger"
                                                                            placeholder="Manuel Ekleme 2"
                                                                            value="<?= $data['rekalm_maliyet_man_2']; ?>">
                                                                    </div>
                                                                </div>
                                ...
                                <div class="col-lg-12 text-end">
                                    <div class="btn-path">
                                        <button type="submit" name="reklamMaliyetDuzenle"
