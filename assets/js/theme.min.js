  ...
  APP.slickSlider = {
    ...
    slickSetup: function (n) {
      ...
      var t,
        ...
        speed: 300,
        vertical: !1,
        prevArrow: '<div class="slick-prev" aria-label="Previous"><i class="fa fa-arrow-left"></i></div>',
        nextArrow: '<div class="slick-next" aria-label="Next"><i class="fa fa-arrow-right"></i></div>',
